...
class VehicleTest extends TestCase
{
    ...
    /** @test */
    public function it_can_update_vehicle_information_with_custom_user_uid()
    {
        $generator = FakerFactory::create('ms_MY');
        ...
        $response = $this->makeClientWithAccessToken($faker)
                        ->uses('Vehicle')
                        ->save($plateNumber, $ownerInformation, $insuranceInformation, $vehicleInformation, 'user-5');
